  ...
  if (!user) {
    return (
      <a
        ...
        className="flex items-center gap-1.5 sm:gap-2 bg-green-600 text-white px-3 sm:px-5 py-2 rounded-xl font-semibold text-xs sm:text-sm hover:bg-green-700 transition-colors whitespace-nowrap"
      >
